    ...
    <footer className="text-white bg-gray-900">
      <div className="container px-4 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div>
            <h3 className="mb-4 text-2xl font-bold">Ksauni Bliss</h3>
            <p className="mb-4 text-gray-400">
              Premium oversized unisex t-shirts for the modern lifestyle. Comfort meets style in every piece.
            </p>
          ...
          <div>
            ...
            <p className="mb-4 text-gray-400">Subscribe to get special offers, free giveaways, and updates.</p>
        ...
        <div className="flex flex-col items-center justify-between pt-8 mt-8 border-t border-gray-800 md:flex-row">
          <p className="text-sm text-gray-400">© 2024 Ksauni Bliss. All rights reserved.</p>
          <div className="flex mt-4 space-x-4 md:mt-0">
            ...
            <img src="/placeholder.svg?height=30&width=50" alt="Razorpay" className="h-6" />
          </div>
        </div>
      </div>
    </footer>
