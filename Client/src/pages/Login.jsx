          ...
          <div className="p-8 border shadow-2xl bg-white/80 backdrop-blur-sm rounded-3xl border-white/20 animate-fade-in-up">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-600">
                ...
                <Link to="/register" className="font-semibold text-pink-500 transition-colors duration-300 hover:text-pink-600">
                  Create one
                </Link>
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <div className="absolute transform -translate-y-1/2 left-4 top-1/2">
                    <svg className="w-5 h-5 text-gray-400 transition-colors duration-300 group-focus-within:text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 text-pink-500 border-2 border-gray-300 rounded focus:ring-pink-400 focus:ring-2" />
                  <span className="text-sm text-gray-600 transition-colors duration-300 group-hover:text-gray-800">Remember me</span>
                </label>
                <Link to="/forgot-password" className="text-sm font-semibold text-pink-500 transition-colors duration-300 hover:text-pink-600">
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 transition-colors duration-300 group-hover:text-gray-900">Google</span>
                </button>
                <button
                  type="button"
                  className="flex items-center justify-center px-4 py-3 transition-all duration-300 border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 group"
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 transition-colors duration-300 group-hover:text-gray-900">Facebook</span>
                </button>
              </div>
            </form>
          </div>
